...
public class PrincipalOauth2Service extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        log.info("oAuth2User: {}", oAuth2User.getAttributes());     //구글: map(String,Object) key값과 value값
        log.info("userRequest: {}", userRequest.getClientRegistration());   //네이버 : map(Key, Value = Map(String,Object))
